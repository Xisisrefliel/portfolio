...
const ReactIcon: React.FC<{ className?: string }> = ({
  className = "w-4 h-4",
}) => (
  <svg
    className={className}
...
const TypeScriptIcon: React.FC<{ className?: string }> = ({
  className = "w-4 h-4",
}) => (
  <svg
    className={className}
...
const TailwindIcon: React.FC<{ className?: string }> = ({
  className = "w-4 h-4",
}) => (
...
const LaravelIcon: React.FC<{ className?: string }> = ({
  className = "w-4 h-4",
}) => (
  <svg
    className={className}
...
const PHPIcon: React.FC<{ className?: string }> = ({
  className = "w-4 h-4",
}) => (
  <svg className={className} viewBox="0 -1 100 50" fill="white">
